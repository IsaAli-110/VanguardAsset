        ...
        <div class="nav-links">
            ...
            <div class="nav-dropdown" data-dropdown>
                ...
                <div class="nav-dropdown-menu">
                    <a href="<?php echo e(route('assets.index')); ?>" class="nav-dropdown-item">
                        <i class="fa-solid fa-list"></i> Katalog Aset
                    </a>
                    <?php if(Auth::user()->isAdmin() || Auth::user()->isManager()): ?>
                    <?php $maintDue = \App\Services\MaintenanceSchedulerService::getMaintenanceDue()->count(); ?>
                    <a href="<?php echo e(route('assets.maintenance')); ?>" class="nav-dropdown-item">
                        <i class="fa-solid fa-screwdriver-wrench"></i> Maintenance
                        <?php if($maintDue > 0): ?>
                            <span class="nav-badge warn" style="margin-left:auto;"><?php echo e($maintDue); ?></span>
                        <?php endif; ?>
                    </a>
                    <?php endif; ?>
                    <?php if(Auth::user()->isAdmin()): ?>
                    <div class="nav-dropdown-divider"></div>
                    <a href="<?php echo e(route('assets.create')); ?>" class="nav-dropdown-item">
            ...
            <a href="<?php echo e(route('approvals.index')); ?>" class="nav-link">
                ...
                ?>
                <?php if($navTotalNotif > 0): ?>
                    <span class="nav-badge" style="<?php echo e($navOverdueCount > 0 ? 'background:#ef4444;' : ''); ?>">
                        <?php echo e($navTotalNotif); ?>
            ...
            <a href="<?php echo e(route('oop.showcase')); ?>" class="nav-link" style="color: #c084fc;">
            ...
            <div class="nav-dropdown" data-dropdown>
                ...
                <div class="nav-dropdown-menu">
                    <a href="<?php echo e(route('security.dashboard')); ?>" class="nav-dropdown-item">
                        <i class="fa-solid fa-shield-halved"></i> Keamanan
                    </a>
                    <a href="<?php echo e(route('users.index')); ?>" class="nav-dropdown-item">
            ...
            <div class="nav-dropdown" data-dropdown>
                ...
                <div class="profile-dropdown-menu">
                    <div class="profile-header">
                        <div class="profile-avatar" style="width:38px;height:38px;font-size:0.9rem;"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></div>
                    ...
                    <div style="padding: 0.5rem 0.85rem;">
                        <span class="user-badge">
                            <?php if(Auth::user()->role === 'admin'): ?> IT Admin
                            <?php elseif(Auth::user()->role === 'manager'): ?> Manajer
                            <?php else: ?> Staf
                            <?php endif; ?>
                        </span>
                    </div>
    ...
    <div class="toast-container" id="toast-container">
        <?php if(session('success')): ?>
            <div class="toast toast-success" role="alert">
                ...
                <div style="flex: 1; font-size: 0.9rem; font-weight: 500;"><?php echo e(session('success')); ?></div>
        ...
        <?php if(session('error')): ?>
            <div class="toast toast-error" role="alert">
                ...
                <div style="flex: 1; font-size: 0.9rem; font-weight: 500;"><?php echo e(session('error')); ?></div>
                <button onclick="this.parentElement.classList.add('hide'); setTimeout(() => this.parentElement.remove(), 300)" style="background: none; border: none; color: var(--text-muted); cursor: pointer;"><i class="fa-solid fa-xmark"></i></button>
            </div>
        <?php endif; ?>
    </div>
...
<?php /**PATH D:\KULIAH\ISA ALI A\OOP\vanguardasset\vanguard-asset-web\resources\views/layouts/app.blade.php ENDPATH**/ ?>