...
<div class="page-header">
    ...
    <p>Berikut ringkasan sistem VanguardAsset Anda — <?php echo e(now()->locale('id')->isoFormat('dddd, D MMMM Y')); ?></p>
</div>
...
<div class="stats-grid">
    ...
    <div class="stat-card" data-tilt>
        ...
        <div class="stat-info"><div class="label">Total Aset</div><div class="value indigo" data-count="<?php echo e($totalAssets); ?>">0</div></div>
        <?php echo $__env->make('partials.sparkline', ['data' => $sparklineData, 'color' => '#818cf8'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
    <?php endif; ?>
    <div class="stat-card" data-tilt>
        <div class="stat-icon emerald"><i class="fa-solid fa-circle-check"></i></div>
        <div class="stat-info"><div class="label">Tersedia</div><div class="value emerald" data-count="<?php echo e($availableAssets); ?>">0</div></div>
    </div>
    <div class="stat-card" data-tilt>
        <div class="stat-icon amber"><i class="fa-solid fa-hand-holding"></i></div>
        <div class="stat-info"><div class="label">Dipinjam</div><div class="value amber" data-count="<?php echo e($borrowedAssets); ?>">0</div></div>
    </div>
    <div class="stat-card" data-tilt>
        <div class="stat-icon rose"><i class="fa-solid fa-wrench"></i></div>
        <div class="stat-info"><div class="label">Dalam Perawatan</div><div class="value rose" data-count="<?php echo e($maintenanceAssets); ?>">0</div></div>
    </div>
    <?php if($user->isAdmin() || $user->isManager()): ?>
    <div class="stat-card" data-tilt>
        <div class="stat-icon sky"><i class="fa-solid fa-clock-rotate-left"></i></div>
        <div class="stat-info"><div class="label">Menunggu Persetujuan</div><div class="value sky" data-count="<?php echo e($pendingRequests); ?>">0</div></div>
    </div>
    <a href="<?php echo e(route('assets.maintenance')); ?>" style="text-decoration:none;color:inherit;">
    <div class="stat-card" data-tilt style="<?php echo e($maintenanceDueCount > 0 ? 'border: 1px solid rgba(245,158,11,0.4);' : ''); ?>">
        <div class="stat-icon" style="<?php echo e($maintenanceDueCount > 0 ? 'background:rgba(245,158,11,0.2);color:#fbbf24;' : 'background:rgba(16,185,129,0.15);color:#34d399;'); ?>"><i class="fa-solid fa-screwdriver-wrench"></i></div>
        <div class="stat-info"><div class="label">Maintenance Due</div><div class="value" data-count="<?php echo e($maintenanceDueCount); ?>" style="<?php echo e($maintenanceDueCount > 0 ? 'color:#fbbf24;' : 'color:#34d399;'); ?>">0</div></div>
    </div>
    </a>
    <div class="stat-card" data-tilt>
        ...
        <div class="stat-info">
            ...
            <div class="currency-value violet">
                ...
                <span class="currency-num" data-count="<?php echo e($totalAssetValue); ?>">0</span>
            </div>
        </div>
    </div>
    <div class="stat-card" data-tilt>
        ...
        <div class="stat-info">
            ...
            <div class="currency-value pink">
                <span class="currency-prefix">Rp</span>
                <span class="currency-num" data-count="<?php echo e($totalDepreciated); ?>">0</span>
            </div>
        </div>
    </div>
    <?php endif; ?>
...
<div class="progress-ring-wrapper" data-tilt>
    <div class="progress-ring">
        <svg width="120" height="120" viewBox="0 0 120 120">
            ...
            <circle class="ring-fill" cx="60" cy="60" r="52"
                stroke="url(#ringGrad)"
                stroke-dasharray="<?php echo e(2 * pi() * 52); ?>"
                stroke-dashoffset="<?php echo e(2 * pi() * 52); ?>"
                data-target-offset="<?php echo e(2 * pi() * 52 * (1 - $availabilityPercent / 100)); ?>"/>
            <defs>
        ...
        <div class="ring-text" style="color:#818cf8;" data-count="<?php echo e($availabilityPercent); ?>">0<span style="font-size:0.9rem;font-weight:600;">%</span></div>
    </div>
    <div class="ring-stats">
        ...
        <div class="ring-label">Dari total <strong style="color:var(--text-main);"><?php echo e($totalAssets); ?></strong> aset, <strong style="color:#34d399;"><?php echo e($availableAssets); ?></strong> tersedia saat ini</div>
        <div style="display:flex;gap:1rem;margin-top:0.25rem;">
            <div class="ring-value"><span style="color:#34d399;">●</span> Tersedia: <?php echo e($availableAssets); ?></div>
            <div class="ring-value"><span style="color:#fbbf24;">●</span> Dipinjam: <?php echo e($borrowedAssets); ?></div>
            <div class="ring-value"><span style="color:#f87171;">●</span> Maintenance: <?php echo e($maintenanceAssets); ?></div>
        </div>
    </div>
</div>
<?php endif; ?>
...
<?php if($overdueRequests->isNotEmpty() && ($user->isAdmin() || $user->isManager())): ?>
<div style="background:rgba(239,68,68,0.06); border:1px solid rgba(239,68,68,0.2); border-radius:var(--radius-lg); padding:1.25rem 1.5rem; margin-bottom:2rem; backdrop-filter:blur(16px);">
    <div style="display:flex; align-items:center; gap:0.5rem; margin-bottom:1rem;">
        ...
        <span style="font-size:1rem; font-weight:700; color:#f87171;">Aset Overdue (<?php echo e($overdueRequests->count()); ?>)</span>
        <a href="<?php echo e(route('approvals.index')); ?>" style="margin-left:auto; font-size:0.8rem; color:var(--text-muted); text-decoration:none;">Lihat Semua <i class="fa-solid fa-arrow-right"></i></a>
    </div>
    <?php $__currentLoopData = $overdueRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $overReq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div style="display:flex; align-items:center; justify-content:space-between; padding:0.6rem 0; border-bottom:1px solid rgba(255,255,255,0.04);">
        <div style="display:flex; align-items:center; gap:0.75rem;">
            <div style="width:32px;height:32px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:0.7rem;font-weight:800;color:white;background:linear-gradient(135deg,#ef4444,#f87171);flex-shrink:0;">
                <?php echo e(strtoupper(substr($overReq->user->name ?? '?', 0, 1))); ?>

            </div>
            <div>
                <div style="font-size:0.88rem; font-weight:600;">
                    <a href="<?php echo e(route('assets.show', $overReq->asset_id)); ?>" style="color:inherit; text-decoration:none;"><?php echo e($overReq->asset->name ?? 'Unknown'); ?></a>
                </div>
                <div style="font-size:0.75rem; color:var(--text-muted);">
                    <?php echo e($overReq->user->name); ?> · Jatuh tempo: <?php echo e($overReq->due_date->format('d M Y')); ?>
        ...
        <span style="background:rgba(239,68,68,0.15); color:#f87171; padding:0.25rem 0.6rem; border-radius:20px; font-size:0.75rem; font-weight:700;">
            <?php echo e($overReq->overdueDays()); ?> hari terlambat
        </span>
    </div>
...
<div class="quick-actions">
    <a href="<?php echo e(route('assets.index')); ?>" class="action-card" data-tilt>
    ...
    <?php if($user->isAdmin()): ?>
    <a href="<?php echo e(route('assets.create')); ?>" class="action-card" data-tilt>
    ...
    <a href="<?php echo e(route('approvals.index')); ?>" class="action-card" data-tilt>
        <i class="fa-solid fa-list-check" style="color:#fbbf24;"></i>
        <div><div class="action-label">Tinjau Permohonan</div><div class="action-desc"><?php echo e($pendingRequests); ?> menunggu persetujuan</div></div>
    </a>
    <?php endif; ?>
    <?php if($user->isStaff()): ?>
    <a href="<?php echo e(route('approvals.index')); ?>" class="action-card" data-tilt>
...
<?php if(($user->isAdmin() || $user->isManager()) && $topExpensiveAssets->isNotEmpty()): ?>
<div class="card" style="padding: 1.75rem;" data-tilt>
    ...
    <div class="table-responsive top-assets-table">
        <table>
            ...
            <tbody>
                <?php $__currentLoopData = $topExpensiveAssets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><span class="rank <?php echo e($i < 3 ? 'rank-'.($i+1) : 'rank-other'); ?>"><?php echo e($i+1); ?></span></td>
                    <td><a href="<?php echo e(route('assets.show', $a->id)); ?>" style="color:#818cf8;text-decoration:none;font-weight:600;"><?php echo e($a->name); ?></a><br><span style="font-size:0.78rem;color:var(--text-muted);"><?php echo e($a->id); ?></span></td>
                    <td><span class="badge badge-info"><i class="fa-solid fa-<?php echo e($a->type === 'physical' ? 'server' : 'cloud'); ?>"></i> <?php echo e(ucfirst($a->type)); ?></span></td>
                    <td style="color:var(--text-muted);font-size:0.9rem;"><?php echo e($a->purchase_date ? $a->purchase_date->format('d M Y') : '—'); ?></td>
                    <td style="text-align:right;font-weight:700;color:#a78bfa;">Rp <?php echo e(number_format($a->purchase_cost, 0, ',', '.')); ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
        </table>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <?php if($user->isAdmin() || $user->isManager()): ?>
                    <td>
                        <div style="font-weight: 600;"><?php echo e($req->user->name); ?></div>
                        <div style="font-size: 0.8rem; color: var(--text-muted);"><?php echo e($req->user->email); ?></div>
                    </td>
                    <?php endif; ?>
                    <td>
                        <a href="<?php echo e(route('assets.show', $req->asset_id)); ?>" style="color: #818cf8; text-decoration: none; font-weight: 600;"><?php echo e($req->asset->name ?? $req->asset_id); ?></a>
                    </td>
                    <td><?php echo e($req->duration); ?> hari</td>
                    <td>
                    ...
                    <td style="color: var(--text-muted); font-size: 0.9rem;"><?php echo e($req->created_at->diffForHumans()); ?></td>
                    <?php if(($user->isAdmin() || $user->isManager()) && $req->status === 'Pending'): ?>
                    <td>
                        <div style="display: flex; gap: 0.5rem;">
                            <form action="<?php echo e(route('approvals.approve', $req->id)); ?>" method="POST" style="margin:0;">
                            ...
                            <form action="<?php echo e(route('approvals.reject', $req->id)); ?>" method="POST" style="margin:0;">
                                <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        new Chart(typeCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [<?php echo e($physicalCount); ?>, <?php echo e($digitalCount); ?>],
        ...
        new Chart(statusCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [<?php echo e($availableAssets); ?>, <?php echo e($borrowedAssets); ?>, <?php echo e($maintenanceAssets); ?>],
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\KULIAH\ISA ALI A\OOP\vanguardasset\vanguard-asset-web\resources\views/dashboard.blade.php ENDPATH**/ ?>