            ...
            <form action="<?php echo e(route('login')); ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="email" id="email" name="email" class="form-control" placeholder="nama@vanguard.com" required value="<?php echo e(old('email')); ?>">
...
<?php /**PATH D:\KULIAH\ISA ALI A\OOP\vanguardasset\vanguard-asset-web\resources\views/auth/login.blade.php ENDPATH**/ ?>